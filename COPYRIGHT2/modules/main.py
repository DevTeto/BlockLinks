...
start_txt = """<b> ✇ انا بوت مسح الروابط من الجروبات </b>

استيطع مسح اي رابط خلال ثانيه فقط قم باضفتي لكي اعمل وظيفه البوت يمسح اي لينك : جميع مواقع المتصفح وحتي البرامج ويمنع الينكات الاباحيه... هذا البوت مقدم مجانا من @TOPTETO

لا تتردد في الإبلاغ عن أي مخاوف، ودعنا نعمل 🤝🔐 """
...
async def start(_, msg):
    ...
    await msg.reply_photo(
        photo="https://telegra.ph/file/b8b3d978bc01bd257316c.jpg",
        caption=start_txt,
...
gd_buttons = [              
        [
            ...
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/WX_PM"),    
        ]
        ]
...
async def activevc(_, message: Message):
    ...
    reply_text = (
        f"✇ مده التشغيل : {uptime}\n"
        f"✇ المعالج : {cpu}%\n"
        f"✇ الذاكره : {size_formatter(storage.total)} [ᴛᴏᴛᴀʟ]\n"
